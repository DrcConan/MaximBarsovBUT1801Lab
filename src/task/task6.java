...
public class task6 {
    ...
    //#5
    static String fifth(String text) {
    ...
    //#7
    static String seventh(String word) {
        String firstW = "";
        String lastW = "";
    ...
    //#9
    static boolean ninth(String formula) {
        formula += " = " + formula;
