...
public class task4 {
    ...
    //#1
    static String first(int n, int k, String s) {
    ...
    //#3
    static String thirdCamel(String snake) {
    ...
    static String thirdSnake(String camel) {
        String result = "";
    ...
    //#4
    static String forth(int start, int end, double pay, double overtime) {
        return String.format("$" + "%.2f", end <= 17 ? (end - start) * pay : (end - start) * pay + (end - 17) * overtime);
    }

    //#5
    static String fifth(String weight, String height) {
    ...
    //#7
    static String seventh(String s) {
        s += " ";
        int count = 1;
        String result = "";
    ...
    //#8
    static boolean eighth(String a, String b) {
    ...
    //#9
    static boolean ninth(long a, long b) {
        int count = 1;
    ...
    //#10
    static int tenth(String stringSequence, char bookEnd) {
        int i = 0;
        int k = 0;
        String res = "";
