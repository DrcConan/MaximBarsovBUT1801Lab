...
public class task2 {
    ...
    //#1
    public static String first(String s, int a) {
        String k = "";
    ...
    //#4
    public static String fourth(int... a) {
    ...
    //#7
    public static boolean seventh(String a) {
    ...
    //#8
    public static boolean eighth(String a, String b) {
        return (a.charAt(0) == b.charAt(b.length() - 1)) & (a.charAt(a.length() - 1) == b.charAt(0));
    }

    //#9
    public static boolean ninthPrefix(String a, String b) {
        return a.startsWith(b.substring(0, b.length() - 1));
    }

    public static boolean ninthSuffix(String a, String b) {
