...
public class task5 {
    ...
    //#1
    static String firstencrypt(String decrypt) {
    ...
    static String firstdecrypt(int[] encrypt) {
    ...
    //#2
    static boolean second(String figure, String start, String end) {
    ...
    //#3
    static boolean third(String s, String w) {
        int i = 0;
    ...
    //#7
    static String seventh(int value) {
        String result = "";
    ...
    //#8
    static String eighth(String line) throws NoSuchAlgorithmException {
